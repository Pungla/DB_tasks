-- Задача 2
-- Объединить в один набор данных автомобили, мотоциклы и велосипеды,
-- удовлетворяющие заданным критериям.
-- Для велосипедов мощность и объем двигателя выводятся как NULL.
-- Сортировка по мощности по убыванию, велосипеды (NULL) в самом низу.
